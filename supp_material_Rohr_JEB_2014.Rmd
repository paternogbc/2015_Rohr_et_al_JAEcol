...
This doccument follows the principles of [reproducible reserach](http://pakillo.github.io/Rmarkdown_talk_SevillaR_Nov2014/#/). All data and code required to repeat the analysis bellow are be available at: [raw data](https://github.com/paternogbc/2014_Rohr_et_al_JEB/blob/master/raw.data_Rhor_JEB.txt) and [source code](https://github.com/paternogbc/2014_Rohr_et_al_JEB/blob/master/Rhor_JEB_2014_source_code.R).
...
theme(legend.position = c(0.2,.8),
      legend.background=element_rect("transparent"));g1
